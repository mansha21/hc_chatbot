...
#        master.minsize(700,350)
    ...
    def createWidget(self):
        self.lblMsg=Label(self, text="Health Care Chatbot", bg="PeachPuff2", width=20, height="2", font=("Calibri", 13))
        #self.lblMsg.pack()
        self.lblMsg.grid(row=0,column=0,rowspan=4,columnspan=20)
        
        
        self.lblQuestion=Label(self,text="Question",width=12,bg="bisque")
        #self.lblQuestion.grid(row=0,column=0,rowspan=4)
        self.lblQuestion.grid(row=5,column=0,rowspan=4)

        self.lblDigonosis = Label(self, text="Digonosis",width=12,bg="bisque")
        #self.lblDigonosis.grid(row=4, column=0,sticky="n",pady=5)
        self.lblDigonosis.grid(row=10, column=0,sticky="n",pady=5)
        ...
        #self.txtQuestion.grid(row=1, column=1,rowspan=4,columnspan=20)
        self.txtQuestion.grid(row=5, column=1,rowspan=4,columnspan=20)
        ...
        self.btnStart.grid(row=32, column=1,columnspan=20,sticky="e")
